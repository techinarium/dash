...
class ScreenshotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screenshot" do
    assert_difference('Screenshot.count') do
      post screenshots_url, params: { screenshot: { screenshot_url: @screenshot.screenshot_url, widget_id: @screenshot.widget_id } }
    end
  ...
  test "should update screenshot" do
    patch screenshot_url(@screenshot), params: { screenshot: { screenshot_url: @screenshot.screenshot_url, widget_id: @screenshot.widget_id } }
